...
USER root
RUN pip install --upgrade pymongo dnspython && update-ca-certificates

# COPY your patched mongodb.py query runner
COPY redash/query_runner/mongodb.py /app/redash/query_runner/mongodb.py

# Ensure runner registration in __init__.py
RUN grep -qxF "from .mongodb import MongoDB" /app/redash/query_runner/__init__.py || echo "from .mongodb import MongoDB" >> /app/redash/query_runner/__init__.py
